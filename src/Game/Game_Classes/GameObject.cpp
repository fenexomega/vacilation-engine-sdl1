...
GameObject::GameObject(int x, int y, int sprite, string s, bool batleble = true) : GObject(x*GE_GLOBAL_TILESIZE,y*GE_GLOBAL_TILESIZE,0,0,true)
{
    this->batable = batleble;
    this->phrase = s;
    this->talkable = true;
    this->X = x;
    this->Y = y;
